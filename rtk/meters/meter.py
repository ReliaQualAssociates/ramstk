...
class ElapsedTime:
    ...
    def __init__(self):
        ...
        self.category = 9                   # Category in relkitcom database.
        self.subcategory = 77               # Subcategory ID in relkitcom database.
...
class Panel:
    ...
    def __init__(self):
        ...
        self.category = 9                       # Category in relkitcom database.
        self.subcategory = 78                   # Subcategory ID in relkitcom database.
