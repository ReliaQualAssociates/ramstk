...
class Dataset:
    ...
    def __init__(self, application):
        ...
        self.txtNumSuspensions = _widg.make_entry(width=100)
        self.txtNumFailures = _widg.make_entry(width=100)

        self.txtMTBF = _widg.make_entry(width=125)
        self.txtMTBFLL = _widg.make_entry(width=125)
        self.txtMTBFUL = _widg.make_entry(width=125)
        self.txtHazardRate = _widg.make_entry(width=125)
        self.txtHazardRateLL = _widg.make_entry(width=125)
        self.txtHazardRateUL = _widg.make_entry(width=125)
        self.txtMTBFi = _widg.make_entry(width=125)
        self.txtMTBFiLL = _widg.make_entry(width=125)
        self.txtMTBFiUL = _widg.make_entry(width=125)
        self.txtHazardRatei = _widg.make_entry(width=125)
        self.txtHazardRateiLL = _widg.make_entry(width=125)
        self.txtHazardRateiUL = _widg.make_entry(width=125)
        ...
        self.txtScale = _widg.make_entry(width=150)
        self.txtScaleLL = _widg.make_entry(width=150)
        self.txtScaleUL = _widg.make_entry(width=150)
        self.txtShape = _widg.make_entry(width=150)
        self.txtShapeLL = _widg.make_entry(width=150)
        self.txtShapeUL = _widg.make_entry(width=150)
        self.txtLocation = _widg.make_entry(width=150)
        self.txtLocationLL = _widg.make_entry(width=150)
        self.txtLocationUL = _widg.make_entry(width=150)

        self.txtShapeShape = _widg.make_entry(width=150)
        self.txtShapeScale = _widg.make_entry(width=150)
        self.txtShapeLocation = _widg.make_entry(width=150)
        self.txtScaleShape = _widg.make_entry(width=150)
        self.txtScaleScale = _widg.make_entry(width=150)
        self.txtScaleLocation = _widg.make_entry(width=150)
        self.txtLocationShape = _widg.make_entry(width=150)
        self.txtLocationScale = _widg.make_entry(width=150)
        self.txtLocationLocation = _widg.make_entry(width=150)
        self.txtAIC = _widg.make_entry(width=150)
        self.txtBIC = _widg.make_entry(width=150)
        self.txtMLE = _widg.make_entry(width=150)
