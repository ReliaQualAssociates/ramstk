...
# -*- coding: utf-8 -*-
#
#       fuse.py is part of The RTK Project
#
# All rights reserved.
...
class Fuse(object):
    ...
    def __init__(self):
        ...
        self.subcategory = 82               # Subcategory in the rtkcom DB.
        self.reason = ""
        ...
        self._in_labels = []
        self._out_labels = [u"<span foreground=\"blue\">\u03BB<sub>p</sub> = \u03BB<sub>b</sub>\u03C0<sub>E</sub></span>",
        ...
        # environments.
        self._derate_criteria = [[0.5, 0.5, 0.0], [0.7, 0.7, 0.0]]
