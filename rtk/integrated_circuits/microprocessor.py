...
# -*- coding: utf-8 -*-
#
#       microprocessor.py is part of The RTK Project
#
# All rights reserved.
...
class Microprocessor(IntegratedCircuit):
    ...
    def __init__(self):
        ...
        self.subcategory = 4                # Subcategory ID in the rtkcom DB.
        ...
        self._lambdab_count = [[[0.028, 0.061, 0.098, 0.091, 0.13, 0.12, 0.13,
                                 0.17, 0.22, 0.18, 0.028, 0.11, 0.24, 3.30],
                                [0.052, 0.110, 0.180, 0.160, 0.23, 0.21, 0.24,
                                 0.32, 0.39, 0.31, 0.052, 0.20, 0.41, 5.60],
                                [0.110, 0.230, 0.360, 0.330, 0.47, 0.44, 0.49,
                                 0.65, 0.81, 0.65, 0.110, 0.42, 0.86, 12.0]],
                               [[0.048, 0.089, 0.130, 0.120, 0.16, 0.16, 0.17,
                                 0.24, 0.28, 0.22, 0.048, 0.15, 0.28, 3.40],
                                [0.093, 0.170, 0.240, 0.220, 0.29, 0.30, 0.32,
                                 0.45, 0.52, 0.40, 0.093, 0.27, 0.50, 5.60],
                                [0.190, 0.340, 0.490, 0.450, 0.60, 0.61, 0.66,
                                 0.90, 1.10, 0.82, 0.190, 0.54, 1.00, 12.0]]]
        # ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- -----

        self._in_labels[3] = _(u"# of Bits:")
    ...
    def assessment_inputs_create(self, part, layout, x_pos, y_pos):
        ...
        part.cmbElements.append_text(_(u"Up to 8 Bits"))
        part.cmbElements.append_text(_(u"Up to 16 Bits"))
        part.cmbElements.append_text(_(u"Up to 32 Bits"))
        part.cmbElements.append_text(_(u"Up to 64 Bits"))
