...
# Create the General Data tab widgets.
    ...
    txtMinTime = _widg.make_entry(_width_=100)
    txtExpTime = _widg.make_entry(_width_=100)
    txtMaxTime = _widg.make_entry(_width_=100)
    txtMinCost = _widg.make_entry(_width_=100)
    txtExpCost = _widg.make_entry(_width_=100)
    txtMaxCost = _widg.make_entry(_width_=100)
    txtMeanTimeLL = _widg.make_entry(_width_=100, editable=False)
    txtMeanTime = _widg.make_entry(_width_=100, editable=False)
    txtMeanTimeUL = _widg.make_entry(_width_=100, editable=False)
    txtMeanCostLL = _widg.make_entry(_width_=100, editable=False)
    txtMeanCost = _widg.make_entry(_width_=100, editable=False)
    txtMeanCostUL = _widg.make_entry(_width_=100, editable=False)

    # These widgets are for the Project Effort.
    txtProjectTimeLL = _widg.make_entry(_width_=100, editable=False)
    txtProjectTime = _widg.make_entry(_width_=100, editable=False)
    txtProjectTimeUL = _widg.make_entry(_width_=100, editable=False)
    txtProjectCostLL = _widg.make_entry(_width_=100, editable=False)
    txtProjectCost = _widg.make_entry(_width_=100, editable=False)
    txtProjectCostUL = _widg.make_entry(_width_=100, editable=False)
