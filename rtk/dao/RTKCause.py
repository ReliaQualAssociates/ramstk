...
class RTKCause(RTK_BASE):
    ...
    def get_attributes(self):
        """
        Retrieve the current values of the RTKCause data model attributes.
    ...
    def set_attributes(self, attributes):
        """
        Set the current values of the RTKCause data model attributes.
        ...
        try:
            ...
            _msg = "RTK ERROR: Missing attribute {0:s} in attribute " \
                   ...
                   "RTKCause.set_attributes().".format(_err)
