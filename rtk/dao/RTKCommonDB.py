...
SiteSession = sessionmaker()
ProgSession = sessionmaker()
...
categories = {0: ('IC', 'Integrated Circuit', 'hardware', 1),
              ...
              16: ('Batch (General)',
                   ...
                   'and wind tunnel data analysis program). Small, throwaway '
                   'programs for preliminary analysis also fit in this '
                   'category.', 'software', 1),
              17: ('Event Control',
...
rpns = {0: ('None', 'No effect.', 'severity', 1),
        1: ('Very Minor', 'System operable with minimal interference.',
            'severity', 2),
        ...
        22: ('High', 'High chance the existing design controls will or can ' 
             'detect a potential mechanism/cause and subsequent failure mode.',
             'detection', 3),
        23: ('Moderately High', 'Moderately high chance the existing design ' 
             'controls will or can detect a potential mechanism/cause and ' 
             'subsequent failure mode.', 'detection', 4),
        24: ('Moderate', 'Moderate chance the existing design controls will ' 
             'or can detect a potential mechanism/cause and subsequent ' 
             'failure mode.', 'detection', 5),
        25: ('Low', 'Low chance the existing design controls will or can ' 
             'detect a potential mechanism/cause and subsequent failure ' 
             'mode.', 'detection', 6),
        26: ('Very Low', 'Very low chance the existing design controls will ' 
             'or can detect a potential mechanism/cause and subsequent ' 
             'failure mode.', 'detection', 7),
        27: ('Remote', 'Remote chance the existing design controls will or ' 
             'can detect a potential mechanism/cause and subsequent failure ' 
             'mode.', 'detection', 8),
        28: ('Very Remote', 'Very remote chance the existing design ' 
             'controls will or can detect a potential mechanism/cause and ' 
             'subsequent failure mode.', 'detection', 9),
        29: ('Absolute Uncertainty', 'Existing design controls will not or ' 
             'cannot detect a potential mechanism/cause and subsequent ' 
             'failure mode; there is no design control.', 'detection', 10)}

statuses = {0: ('Initiated', 'Incident has been initiated.', 'incident'),
...
criticalitys = {0: ('Catastrophic',
                ...
                2: ('Marginal',
                    ...
                    'but less than $200K, or mitigatible environmental damage ' 
                    'without violation of law or regulation where restoration '
                    'activities can be accomplished.', 'III', 2),
                3: ('Negligble',
                    'Could result in injury or illness not resulting in a '
                    'lost work day, loss exceeding $2K but less than $10K, or '
