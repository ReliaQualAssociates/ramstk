...
RTK_CATEGORIES = {0: ('IC', 'Integrated Circuit', 'hardware', 1),
...
RTK_ENVIRONS = {0: ('GB', 'Ground, Benign', 'active', 0.5, 1.0),
                ...
                8: ('AUF', 'Airborne, Uninhabited, Fighter', 'active', 8.0,
                    1.0),
...
RTK_GROUPS = {0: ('Engineering, Design', 'workgroup'),
...
RTK_LEVELS = {0: ('Software System', 'software', 0),
...
RTK_MODELS = {0: ('Equal Apportionment', 'allocation'),
...
RTK_PHASES = {0: ('Concept/Planning (PCP)', 'development'),
...
RTK_RPNS = {0: ('None', 'No effect.', 'severity', 1),
...
RTK_TYPES = {0: ('CALC', 'Calculated', 'cost'),
             1: ('DEF', 'Defined', 'cost'),
             2: ('ASS', 'Assessed', 'mtbf'),
             ...
             46: ('TOL', 'System Engineering, Tolerance Analysis',
                  'validation'),
             47: ('WCA', 'System Engineering, Worst Case Analysis',
                  'validation')}

RTK_APPLICATIONS = {0: ('Airborne', 0.0128, 6.28),
...
RTK_CRITICALITIES = {0: ('Catastrophic',
...
RTK_HAZARDS = {0: ('Acceleration/Gravity', 'Falls'),
...
RTK_MANUFACTURERS = {0: ('Sprague', 'New Hampshire', '13606'),
                     1: ('Xilinx', '', ''),
                     2: ('National Semiconductor', 'California', '27014')}

RTK_UNITS = {0: ('lbf', 'Pounds Force', 'measurement'),
...
RTK_CONDITIONS = {0: ('Cavitation', 'operating'),
...
RTK_MEASUREMENTS = {0: ('Contamination, Concentration',),
