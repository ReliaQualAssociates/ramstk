...
class Mechanical(Relay):
    ...
    :cvar subcategory: default value: 64

    :ivar temperature_rating: default value: 0
    :ivar load_type: default value: 0
    :ivar contact_form: default value: 0
    :ivar contact_rating: default value: 0
    ...
    _lst_lambdab_count = [[0.13, 0.28, 2.1, 1.1, 3.8, 1.1, 1.4, 1.9, 2.0, 7.0,
                           0.66, 3.5, 10.0, 0.0],
                          [0.43, 0.89, 6.9, 3.6, 12.0, 3.4, 4.4, 6.2, 6.7, 22.0,
                           0.21, 11.0, 32.0, 0.0],
                          [0.13, 0.26, 2.1, 1.1, 3.8, 1.1, 1.4, 1.9, 2.0, 7.0,
                           0.66, 3.5, 10.0, 0.0],
                          [0.11, 0.23, 1.8, 0.92, 3.3, 0.96, 1.2, 2.1, 2.3, 6.5,
                           0.54, 3.0, 9.0, 0.0],
    ...
    def __init__(self):
        """
        Initialize an Mechanical Relay data model instance.
        """
    ...
    def set_attributes(self, values):
        """
        Sets the Mechanical Relay data model attributes.
    ...
    def get_attributes(self):
        """
        Retrieves the current values of the Mechanical Relay data model attributes.
        ...
        if self.hazard_rate_type == 1:
            ...
            if self.quality < 7:            # MIL-SPEC
                ...
                if self.cycles_per_hour > 1000.0:
                    ...
                    self.piCYC = self.cycles_per_hour / 10.0    # pragma: no cover
                else:
                    self.piCYC = 1.0
