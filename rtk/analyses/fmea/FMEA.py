...
class FMEA(RTKDataController):
    ...
    def request_delete(self, node_id):
        ...
        _entity = self._dtm_fmea.tree.get_node(node_id).data

        if _entity.is_mode:
            _pub_msg = 'deletedMode'
        elif _entity.is_mechanism:
            _pub_msg = 'deletedMechanism'
        elif _entity.is_cause:
            _pub_msg = 'deletedCause'
        elif _entity.is_control:
            _pub_msg = 'deletedControl'
        elif _entity.is_action:
            _pub_msg = 'deletedAction'
