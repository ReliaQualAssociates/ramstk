...
# -*- coding: utf-8 -*-
#
#       rtk.analyses.prediction.Crystal.py is part of the RTK Project
#
# All rights reserved.
# Copyright 2007 - 2017 Andrew Rowland andrew.rowland <AT> reliaqual <DOT> com
"""Crystal Calculations Module."""
...
def calculate(**attributes):
    """
    Calculate the hazard rate for a crystal.
    ...
    if attributes['mult_adj_factor'] <= 0.0:
        _msg = _msg + 'RTK WARNING: Multiplicative adjustment factor is 0.0 ' \
            'when calculating crystal, hardware ID: ' \
