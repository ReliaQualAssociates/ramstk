...
class Results(gtk.HPaned):                  # pylint: disable=R0902, R0904
    ...
    def __init__(self):
        ...
        self.txtEtaLL = _widg.make_entry(width=100, editable=False)
        self.txtEta = _widg.make_entry(width=100, editable=False)
        self.txtEtaUL = _widg.make_entry(width=100, editable=False)
        self.txtBetaLL = _widg.make_entry(width=100, editable=False)
        self.txtBeta = _widg.make_entry(width=100, editable=False)
        self.txtBetaUL = _widg.make_entry(width=100, editable=False)
        self.txtEtaEta = _widg.make_entry(width=100, editable=False)
        self.txtEtaBeta = _widg.make_entry(width=100, editable=False)
        self.txtBetaEta = _widg.make_entry(width=100, editable=False)
        self.txtBetaBeta = _widg.make_entry(width=100, editable=False)
    ...
    def create_results_page(self):
        ...
        _label = _widg.make_label(_(u"<span>\u03B7</span>"),
                                  width=-1, justify=gtk.JUSTIFY_CENTER)
        _fxdEstimates.put(_label, _x_pos + 45, _y_pos[1] + 90)
        _label = _widg.make_label(_(u"<span>\u03B2</span>"),
                                  width=-1, justify=gtk.JUSTIFY_CENTER)
        ...
        _fxdEstimates.put(self.txtEtaEta, _x_pos, _y_pos[1] + 120)
        _fxdEstimates.put(self.txtEtaBeta, _x_pos + 105, _y_pos[1] + 120)
        _fxdEstimates.put(self.txtBetaEta, _x_pos, _y_pos[1] + 150)
        _fxdEstimates.put(self.txtBetaBeta, _x_pos + 105, _y_pos[1] + 150)
...
# TODO: Move these calculations to the Weibull distribution data model class.
        ...
        _widg.load_plot(self.axAxis1, self.pltPlot1, x=times, y1=_bin_edges,
