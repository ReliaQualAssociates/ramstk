...
"""
######################################################
Survival Package LogNormal Distribution Work Book View
######################################################
"""

# -*- coding: utf-8 -*-
#
#       rtk.survival.gui.gtk.LogNormal.py is part of The RTK Project
#
# All rights reserved.
...
class Results(gtk.HPaned):                  # pylint: disable=R0902, R0904
    """
    The Work Book page to display all the attributes for an LogNormal
    distribution.  The attributes of an LogNormal Results page are:
    ...
    :ivar gtk.Entry txtLogMeanLL:
    :ivar gtk.Entry txtLogMean:
    :ivar gtk.Entry txtLogMeanUL:
    :ivar gtk.Entry txtSigmaLL:
    :ivar gtk.Entry txtSigma:
    :ivar gtk.Entry txtSigmaUL:
    :ivar gtk.Entry txtLogMeanSigma:
    :ivar gtk.Entry txtLogMeanLogMean:
    :ivar gtk.Entry txtLogMeanSigma:
    :ivar gtk.Entry txtSigmaLogMean:
    ...
    def __init__(self):
        """
        Initializes the Results page for the LogNormal distribution.
        """
        ...
        self.txtLogMeanLL = _widg.make_entry(width=100, editable=False)
        self.txtLogMean = _widg.make_entry(width=100, editable=False)
        self.txtLogMeanUL = _widg.make_entry(width=100, editable=False)
        ...
        self.txtLogMeanLogMean = _widg.make_entry(width=100, editable=False)
        self.txtLogMeanSigma = _widg.make_entry(width=100, editable=False)
        self.txtSigmaLogMean = _widg.make_entry(width=100, editable=False)
    ...
    def create_results_page(self):
        ...
        analysis for the LogNormal distribution.
        ...
        self.txtHazardRateUL.set_tooltip_markup(_(u"Displays the upper "
                                                  ...
                                                  u"bound on the hazard "
                                                  u"rate."))
        self.txtLogMeanLL.set_tooltip_markup(_(u"Displays the lower "
                                               u"<span>\u03B1</span>% bound "
                                               u"on the scale parameter."))
        self.txtLogMean.set_tooltip_markup(_(u"Displays the point estimate of "
                                             u"the scale parameter."))
        self.txtLogMeanUL.set_tooltip_markup(_(u"Displays the upper "
                                               u"<span>\u03B1</span>% bound "
                                               u"on the scale parameter."))
        ...
        self.txtSigmaUL.set_tooltip_markup(_(u"Displays the upper "
                                             u"<span>\u03B1</span>% bound on "
                                             u"the shape parameter."))
        self.txtLogMeanLogMean.set_tooltip_markup(_(u"Displays the variance "
                                                    u"of the scale "
                                                    u"parameter."))
        self.txtLogMeanSigma.set_tooltip_markup(_(u"Displays the covariance "
                                                  u"of the scale and shape "
                                                  u"parameters."))
        self.txtSigmaLogMean.set_tooltip_markup(_(u"Displays the covariance "
        ...
        _labels = [_(u"Scale Parameter (<span>\u03BC<sup>'</sup></span>):"),
                   _(u"Shape Parameter (<span>\u03C3<sup>'</sup></span>):")]
        ...
        _fxdEstimates.put(self.txtLogMeanLL, _x_pos, _y_pos[0])
        _fxdEstimates.put(self.txtLogMean, _x_pos + 105, _y_pos[0])
        _fxdEstimates.put(self.txtLogMeanUL, _x_pos + 210, _y_pos[0])
        ...
        _label = _widg.make_label(_(u"<span>\u03BC<sup>'</sup></span>"),
                                  width=-1, justify=gtk.JUSTIFY_CENTER)
        _fxdEstimates.put(_label, _x_pos + 45, _y_pos[1] + 90)
        _label = _widg.make_label(_(u"<span>\u03C3<sup>'</sup></span>"),
                                  width=-1, justify=gtk.JUSTIFY_CENTER)
        ...
        _fxdEstimates.put(self.txtLogMeanLogMean, _x_pos, _y_pos[1] + 120)
        _fxdEstimates.put(self.txtLogMeanSigma, _x_pos + 105, _y_pos[1] + 120)
        _fxdEstimates.put(self.txtSigmaLogMean, _x_pos, _y_pos[1] + 150)
        ...
        self.lblPage.set_tooltip_text(_(u"Displays LogNormal distribution "
    ...
    def load_results_page(self, model):
        ...
        of fitting a dataset to the LogNormal distribution.
        ...
        self.txtLogMeanLL.set_text(str(fmt.format(self._model.scale[0])))
        self.txtLogMean.set_text(str(fmt.format(self._model.scale[1])))
        self.txtLogMeanUL.set_text(str(fmt.format(self._model.scale[2])))
...
class Plots(gtk.HBox):                      # pylint: disable=R0902, R0904
    """
    The Work Book page to display plots for an LogNormal distribution.  The
    attributes of an LogNormal Plot page are:
    ...
    def __init__(self):
        """
        Initializes the Plot page for the LogNormal distribution.
        """
    ...
    def create_plot_page(self):
        """
        Method to create the page for displaying plots for the LogNormal
        distribution.
    ...
    def load_plots(self, model):
        """
        Method to load the plots for the LogNormal distribution.
...
# TODO: Move these calculations to the LogNormal distribution data model class.
    ...
    def _load_ecdf(self, times, theoretical):
        ...
        _title = _(u"LogNormal Empirical CDF of Failure Times "
                   u"for {0:s}").format(self._model.description)
    ...
    def _load_probability_plot(self, times):
        ...
        _title = _(u"LogNormal Probability Plot of Failure Times "
                   u"for {0:s}").format(self._model.description)
