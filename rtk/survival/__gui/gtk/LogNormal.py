...
class Results(gtk.HPaned):                  # pylint: disable=R0902, R0904
    ...
    def __init__(self):
        ...
        self.txtLogMeanLL = Widgets.make_entry(width=100, editable=False)
        self.txtLogMean = Widgets.make_entry(width=100, editable=False)
        self.txtLogMeanUL = Widgets.make_entry(width=100, editable=False)
        ...
        self.txtLogMeanLogMean = Widgets.make_entry(width=100, editable=False)
        self.txtLogMeanSigma = Widgets.make_entry(width=100, editable=False)
        self.txtSigmaLogMean = Widgets.make_entry(width=100, editable=False)
    ...
    def create_results_page(self):
        ...
        # Column labels.
        _label = Widgets.make_label(_(u"<span>\u03BC<sup>'</sup></span>"),
                                    width=100, justify=gtk.JUSTIFY_CENTER)
        _fxdEstimates.put(_label, 25, _y_pos[1] + 90)
        _label = Widgets.make_label(_(u"<span>\u03C3<sup>'</sup></span>"),
                                    width=100, justify=gtk.JUSTIFY_CENTER)
        _fxdEstimates.put(_label, 130, _y_pos[1] + 90)

        # Row labels.
        _label = Widgets.make_label(_(u"<span>\u03BC<sup>'</sup></span>"),
                                    width=10, justify=gtk.JUSTIFY_RIGHT)
        _fxdEstimates.put(_label, 5, _y_pos[1] + 120)
        _label = Widgets.make_label(_(u"<span>\u03C3<sup>'</sup></span>"),
                                    width=10, justify=gtk.JUSTIFY_RIGHT)
        _fxdEstimates.put(_label, 5, _y_pos[1] + 150)

        _fxdEstimates.put(self.txtLogMeanLogMean, 25, _y_pos[1] + 120)
        _fxdEstimates.put(self.txtLogMeanSigma, 130, _y_pos[1] + 120)
        _fxdEstimates.put(self.txtSigmaLogMean, 25, _y_pos[1] + 150)
