...
# -*- coding: utf-8 -*-
#
#       tests.exim.imports_unit_test.py is part of The RAMSTK Project
#
# All rights reserved.
...
@pytest.mark.usefixtures("test_csv_file_function")
class TestImport:
    ...
    def test_create_import(self):
        ...
        assert pub.isSubscribed(DUT._do_connect, "succeed_connect_program_database")
    ...
    def test_do_map_field_hardware(self, test_csv_file_hardware):
        ...
        assert DUT._dic_field_map["Hardware"] == OrderedDict(
            [
                ...
                ("Composite Ref. Des.", "Comp. Ref. Des."),
                ("Cost", "Unit Cost"),
                ("Cost Type", "Cost Type"),
    ...
    def test_do_map_field_design_electric(self, test_csv_file_hardware):
        ...
        for _idx, _key in enumerate(DUT._dic_field_map["Design Electric"]):
            if _idx == 0:
                ...
                DUT._do_map_to_field(
                    "Design Electric", list(DUT._df_input_data)[_idx + 28], _key
                )
    ...
    def test__do_replace_nan_numpy_nan(self):
        """_do_replace_nan() should return the default value if passed NaN."""
        assert _do_replace_nan(np.nan, "Suck It, Real Good") == "Suck It, Real Good"
