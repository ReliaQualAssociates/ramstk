...
def test_get_part_count_lambda_b_logic(
    technology_id, environment_active_id, n_elements
):
    """get_part_count_lambda_b() should return a float value for the parts
    count base hazard rate on success."""
    _lambda_b = integratedcircuit.get_part_count_lambda_b(
...
def test_get_part_count_lambda_b_pal_pla(
    technology_id, environment_active_id, n_elements_id
):
    """get_part_count_lambda_b() should return a float value for the parts
    count base hazard rate on success."""
    _n_elements = {1: [200, 1000, 5000], 2: [16000, 64000, 256000, 1000000]}[
        technology_id
    ][n_elements_id]
...
def test_get_part_count_lambda_b_rom_sram(
    subcategory_id, technology_id, environment_active_id, n_elements
):
    """get_part_count_lambda_b() should return a float value for the parts
    count base hazard rate on success."""
    _lambda_b = integratedcircuit.get_part_count_lambda_b(
...
def test_get_part_count_lambda_b_prom_dram(
    subcategory_id, environment_active_id, n_elements
):
    """get_part_count_lambda_b() should return a float value for the parts
    count base hazard rate on success."""
    _lambda_b = integratedcircuit.get_part_count_lambda_b(
...
def test_get_part_count_lambda_b_gaas(
    environment_active_id, n_elements_id, technology_id
):
    """get_part_count_lambda_b() should return a float value for the parts
    count base hazard rate on success."""
    _n_elements = {1: [10, 100], 2: [1000, 10000]}[technology_id][n_elements_id]
    _lambda_b = integratedcircuit.get_part_count_lambda_b(
        _n_elements,
        id_keys={
            "subcategory_id": 9,
...
def test_get_die_complexity_factor(subcategory_id, technology_id):
    """get_die_complexity_factor() should return a float value for C1 on
    success."""
...
def test_get_die_complexity_factor_no_subcategory():
    """get_die_complexity_factor() should raise a KeyError when passed an
...
def test_get_die_complexity_factor_unknown_n_elements():
    """get_die_complexity_factor() should use the breakpoint value for the
    closest number of elements when passed a non-key number of elements."""
...
def test_calculate_package_factor(package_id):
    """calculate_package_factor() should return a float value for C2 on
    success."""
...
def test_calculate_junction_temperature():
    """calculate_junction_temperature() should return a float value for Tj on
    success."""
...
def test_calculate_temperature_factor_no_subcategory():
    """calculate_temperature_factor() should raise a KeyError when passed an
    unknown subcategory ID."""
    with pytest.raises(KeyError):
...
def test_calculate_temperature_factor_no_family():
    """calculate_temperature_factor() should raise an IndexError when passed an
    unknown family ID."""
...
def test_get_application_factor():
    """get_application_factor() should return a float value for piA on
    success."""
...
def test_get_application_factor_no_type():
    """get_application_factor() should raise a KeyError when passed an unknown
    type ID."""
    with pytest.raises(KeyError):
...
def test_get_application_factor_no_application():
    """get_application_factor() should raise an IndexError when passed an
    unknown application ID."""
    with pytest.raises(IndexError):
...
def test_get_error_correction_factor_no_type():
    """get_error_correction_factor() should raise a KeyError when passed an
    unknown type ID."""
    with pytest.raises(KeyError):
...
def test_calculate_lambda_cyclic_factors(construction_id, n_cycles):
    """calculate_lambda_cyclic_factors() should return a tuple float values for
    A1, A2, B1, and B2 on success."""
...
def test_get_manufacturing_process_factor(manufacturing_id):
    """get_manufacturing_process_factor() should return a float value for piMFG
    on success."""
...
def test_calculate_die_complexity_factor():
    """calculate_die_complexity_factor() should return a float value for piCD
    on success."""
...
def test_calculate_die_complexity_factor_zero_feature():
    """calculate_die_complexity_factor() should raise a ZeroDivisionError when
    passed a feature size=0.0."""
...
def test_get_package_type_correction_factor(package_id):
    """get_package_type_correction_factor() should return a float value for
    piPt on success."""
...
def test_get_package_type_correction_factor_no_package():
    """get_package_type_correction_factor() should raise a KeyError when passed
...
def test_calculate_package_base_hazard_rate():
    """calculate_package_base_hazard_rate() should return a float value for
    lambdaBP on success."""
