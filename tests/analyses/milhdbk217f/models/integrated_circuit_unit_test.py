...
def test_calculate_part_count_linear(test_attributes_integrated_circuit):
    """calculate_part_count() should return a float value for the parts count base
    hazard rate on success."""
    _lambda_b = integratedcircuit.calculate_part_count(
...
def test_get_die_complexity_factor_unknown_n_elements():
    """get_die_complexity_factor() should use the breakpoint value for the closest
    number of elements when passed a non-key number of elements."""
...
def test_calculate_lambda_cyclic_factors(construction_id, n_cycles):
    """calculate_lambda_cyclic_factors() should return a tuple float values for A1, A2,
    B1, and B2 on success."""
...
def test_get_manufacturing_process_factor(manufacturing_id):
    """get_manufacturing_process_factor() should return a float value for piMFG on
    success."""
...
def test_calculate_die_complexity_factor():
    """calculate_die_complexity_factor() should return a float value for piCD on
    success."""
...
def test_calculate_package_base_hazard_rate():
    """calculate_package_base_hazard_rate() should return a float value for lambdaBP on
    success."""
...
@pytest.mark.unit
@pytest.mark.usefixtures("test_attributes_integrated_circuit")
def test_calculate_part_stress(test_attributes_integrated_circuit):
...
@pytest.mark.unit
@pytest.mark.usefixtures("test_attributes_integrated_circuit")
def test_calculate_part_stress_gaas(test_attributes_integrated_circuit):
    """calculate_part_stress() should return a the attributes dict updated with
    calculated values."""
...
@pytest.mark.unit
@pytest.mark.usefixtures("test_attributes_integrated_circuit")
def test_calculate_part_stress_vlsi(test_attributes_integrated_circuit):
    """calculate_part_stress() should return a the attributes dict updated with
    calculated values."""
