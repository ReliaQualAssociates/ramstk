...
def test_calculate_part_count(test_attributes_meter):
    """calculate_part_count() should return a float value for the parts count base
    hazard rate on success."""
    _lambda_b = meter.calculate_part_count(**test_attributes_meter)
...
def test_get_part_stress_lambda_b(subcategory_id, type_id):
    """get_part_stress_lambda_b() should return a float value for the part stress base
    hazard rate on success."""
...
def test_get_part_stress_lambda_b_no_subcategory():
    """get_part_stress_lambda_b() should return 0.0 when passed an unknown subcategory
    ID."""
...
def test_get_temperature_stress_factor(temperature_active):
    """get_temperature_stress_factor() should return a float value for piT on
    success."""
...
@pytest.mark.unit
@pytest.mark.usefixtures("test_attributes_meter")
def test_calculate_part_stress_elapsed_time_meter(test_attributes_meter):
...
@pytest.mark.unit
@pytest.mark.usefixtures("test_attributes_meter")
def test_calculate_part_stress_panel_meter(test_attributes_meter):
    """calculate_part_stress() should return a dictionary of updated values on
    success."""
...
@pytest.mark.unit
@pytest.mark.usefixtures("test_attributes_meter")
def test_calculate_part_stress_no_subcategory(test_attributes_meter):
    """calculate_part_stress() should return a dictionary of updated values on
    success."""
    test_attributes_meter["subcategory_id"] = 3
    _attributes = meter.calculate_part_stress(**test_attributes_meter)
