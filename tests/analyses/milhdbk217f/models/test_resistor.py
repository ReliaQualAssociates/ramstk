...
def test_get_resistance_factor(subcategory_id):
    """calculate_resistance_factor() should return a float value for piR on
    success."""
    _attributes = copy.deepcopy(ATTRIBUTES)
    _attributes["subcategory_id"] = subcategory_id
    _attributes["specification_id"] = 1
...
def test_get_resistance_factor_no_specification():
    """calculate_resistance_factor() should raise an IndexError when passed an
...
def test_get_resistance_factor_no_subcategory():
    """calculate_resistance_factor() should raise a KeyError when passed an
...
def test_calculate_temperature_factor():
    """calculate_temperature_factor() should return a tuple of two float values
    for case temperature and piT on success."""
    _attributes = copy.deepcopy(ATTRIBUTES)
...
def test_get_voltage_factor_no_subcategory():
    """get_voltage_factor() should raise a KeyError if passed an unknown
    subcategory ID."""
    _attributes = copy.deepcopy(ATTRIBUTES)
...
def test_calculate_part_stress(subcategory_id):
    """calculate_part_stress() should return the attributes dict with updated
    values on success."""
    _attributes = copy.deepcopy(ATTRIBUTES)
    _attributes["subcategory_id"] = subcategory_id
