...
def test_calculate_arinc_apportionment():
    ...
    _attributes = allocation._calculate_arinc_apportionment(0.0000482, _attributes)
...
def test_calculate_equal_negative_goal():
    ...
    _attributes["mission_time"] = 100.0
    _attributes["weight_factor"] = 1.0 / 3.0
    _attributes = allocation._calculate_equal_apportionment(-0.99995, _attributes)
...
def test_calculate_foo_apportionment():
    ...
    _attributes = allocation._calculate_foo_apportionment(0.0000482, 3528, _attributes)
...
def test_calculate_foo_zero_cum_weight():
    ...
    _attributes = allocation._calculate_foo_apportionment(0.0000482, 0, _attributes)
...
def test_calculate_foo_zero_goal():
    ...
    _attributes = allocation._calculate_foo_apportionment(0.0, 3528, _attributes)
