...
from ramstk.analyses.statistics.bounds import (
    do_calculate_beta_bounds, do_calculate_fisher_information
)
...
class TestFisherInformation:
    ...
    def test_calculate_fisher_information(self):
        ...
        _fisher = do_calculate_fisher_information(log_pdf, _p0,
                                                  self.EXP_TEST[:, 1])

        assert _fisher[0][0] == pytest.approx(7.56458685e+05)
