...
class TestAnalysisMethods:
    ...
    def test_do_calculate_criticality(self, test_attributes, test_datamanager):
        ...
        test_datamanager.tree.get_node(5).data["mode"].mode_ratio = 0.428
        test_datamanager.tree.get_node(5).data["mode"].mode_op_time = 4.2
        test_datamanager.tree.get_node(5).data["mode"].effect_probability = 1.0
        test_datamanager.tree.get_node(5).data["mode"].severity_class = "III"

        pub.sendMessage("request_calculate_criticality", item_hr=0.00000682)

        assert test_datamanager.tree.get_node(5).data[
            "mode"
