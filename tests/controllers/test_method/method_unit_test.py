...
class TestCreateControllers:
    ...
    def test_data_manager_create(self, test_datamanager):
        ...
        assert test_datamanager._db_id_colname == "fld_test_id"
        assert test_datamanager._db_tablename == "ramstk_test_method"
        ...
        assert pub.isSubscribed(
            test_datamanager.do_insert, "request_insert_test_method"
        )
...
class TestSelectMethods:
    ...
    def test_do_select(self, test_attributes, test_datamanager):
        ...
        _test_method = test_datamanager.do_select(2)
