...
class TestUpdateMethods:
    ...
    def on_fail_update_non_existent_id(self, error_message):
        assert error_message == (
            "do_update: Attempted to save non-existent " "Site ID skullduggery."
        )
        print("\033[35m\nfail_update_options topic was broadcast")

    def on_fail_update_no_data_package(self, error_message):
        assert error_message == (
            "do_update: No data package found for Site 1 " "options."
        )
        print("\033[35m\nfail_update_options topic was broadcast")
    ...
    def test_do_update_non_existent_id(self, mock_common_dao):
        ...
        pub.subscribe(self.on_fail_update_non_existent_id, "fail_update_options")
        ...
        pub.unsubscribe(self.on_fail_update_non_existent_id, "fail_update_options")

    @pytest.mark.unit
    def test_do_update_no_data_package(self, mock_common_dao):
        """do_update() should return a non-zero error code when passed a
        Options ID that doesn't exist."""
        pub.subscribe(self.on_fail_update_no_data_package, "fail_update_options")
        ...
        pub.unsubscribe(self.on_fail_update_no_data_package, "fail_update_options")
