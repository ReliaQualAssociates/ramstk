...
class TestUpdateMethods:
    ...
    def test_do_update_all(self, test_program_dao):
        ...
        assert (
            DUT.do_select(1, table="validation").description == "Big test validation #1"
        )
        assert (
            DUT.do_select(2, table="validation").description == "Big test validation #2"
        )
...
class TestAnalysisMethods:
    ...
    @pytest.mark.integration
    def test_do_select_actuals(self, test_program_dao, test_toml_user_configuration):
