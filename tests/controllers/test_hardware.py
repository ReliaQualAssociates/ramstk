...
class TestGetterSetter():
    ...
    @pytest.mark.unit
    def testdo_set_attributes(self, mock_program_dao):
...
class TestAnalysisMethods():
    ...
    def on_succeed_calculate_all_hardware(self, module_tree):
    ...
    def test_do_calculate_assembly_specified_hazard_rate(
        ...
        DATAMGR.do_set_attributes([1, -1], {'add_adj_factor': 0.1})
        DATAMGR.do_set_attributes([1, -1], {'mult_adj_factor': 1.25})
        DATAMGR.do_set_attributes([1, -1], {'mission_time': 10.0})
        DATAMGR.do_set_attributes([1, -1], {'quantity': 1})
        DATAMGR.do_set_attributes([1, -1], {'cost_type_id': 2})
        DATAMGR.do_set_attributes([1, -1], {'cost': 5.28})
        DATAMGR.do_set_attributes([1, -1], {'total_part_count': 10})
    ...
    def test_do_calculate_assembly_specified_mtbf(
        ...
        DATAMGR.do_set_attributes([1, -1], {'add_adj_factor': 0.0})
        DATAMGR.do_set_attributes([1, -1], {'mult_adj_factor': 1.0})
        DATAMGR.do_set_attributes([1, -1], {'mission_time': 10.0})
    ...
    def test_do_calculate_assembly_zero_specified_mtbf(
        ...
        DATAMGR.do_set_attributes([1, -1],
                                            {'hazard_rate_type_id': 3})
        DATAMGR.do_set_attributes([1, -1], {'mtbf_specified': 0.0})
        DATAMGR.do_set_attributes([1, -1],
                                            {'hazard_rate_dormant': 0.0})
        DATAMGR.do_set_attributes([1, -1],
                                            {'hazard_rate_software': 0.0})
    ...
    def test_do_calculate_all_hardware(self, mock_program_dao,
        ...
        pub.subscribe(self.on_succeed_calculate_all_hardware,
                      'succeed_calculate_all_hardware')
        ...
        DATAMGR.do_set_attributes([1, -1], {'total_part_count': 89})
        DATAMGR.do_set_attributes([1, -1],
                                            {'total_power_dissipation': 45.89})
        DATAMGR.do_set_attributes([1, -1], {'cost': 438.19})
        DATAMGR.do_set_attributes([1, -1], {'mission_time': 10.0})
        DATAMGR.do_update(1)

        # Do a couple of assemblies with a specified MTBF
        DATAMGR.do_set_attributes([2, -1],
                                            {'hazard_rate_type_id': 3})
        DATAMGR.do_set_attributes([2, -1], {'mtbf_specified': 38292})
        DATAMGR.do_set_attributes([2, -1],
                                            {'hazard_rate_software': 0.045})
        DATAMGR.do_set_attributes([2, -1], {'total_part_count': 55})
        DATAMGR.do_set_attributes([2, -1],
                                            {'total_power_dissipation': 4.67})
        DATAMGR.do_set_attributes([2, -1], {'cost': 1282.95})
        DATAMGR.do_set_attributes([2, -1], {'mission_time': 10.0})
        DATAMGR.do_update(2)
    ...
    def test_do_calculate_reliability_metrics_zero_mtbf(
        ...
        DUT._attributes['hazard_rate_type_id'] = 3
        DUT._attributes['mtbf_specified'] = 0.0
        DUT._attributes['hazard_rate_active'] = 0.0
        DUT._attributes['hazard_rate_dormant'] = 0.0001
        DUT._attributes['hazard_rate_software'] = 0.003
        DUT._attributes['add_adj_factor'] = 0.0
        DUT._attributes['mult_adj_factor'] = 1.0
        DUT._attributes['mission_time'] = 1.0
...
class TestMilHdbk217FPredictions():
    ...
    def test_do_calculate_part_mil_hdbk_217f_parts_count(
        ...
        DATAMGR.do_set_attributes([1, -1], {'category_id': 1})
        DATAMGR.do_set_attributes([1, -1], {'subcategory_id': 1})
        DATAMGR.do_set_attributes([1, -1], {'quality_id': 1})
        DATAMGR.do_set_attributes([1, -1],
                                            {'environment_active_id': 3})
        DATAMGR.do_set_attributes([1, -1],
                                            {'environment_dormant_id': 2})
        DATAMGR.do_set_attributes([1, -1], {'n_elements': 100})
        DATAMGR.do_set_attributes([1, -1], {'power_operating': 0.05})
        DATAMGR.do_set_attributes([1, -1],
                                            {'hazard_rate_software': 0.3876})
        DATAMGR.do_set_attributes([1, -1], {'add_adj_factor': 0.0})
        DATAMGR.do_set_attributes([1, -1], {'mult_adj_factor': 1.0})
        ...
        DATAMGR.do_set_attributes([1, -1], {'cost_type_id': 2})
        DATAMGR.do_set_attributes([1, -1], {'cost': 5.28})
        DATAMGR.do_set_attributes([1, -1], {'part': 1})
        DATAMGR.do_update(1)
    ...
    def test_do_calculate_part_mil_hdbk_217f_parts_stress(
        ...
        DATAMGR.do_set_attributes([1, -1], {'construction_id': 1})
        DATAMGR.do_set_attributes([1, -1], {'configuration_id': 1})
        DATAMGR.do_set_attributes([1, -1], {'resistance': 0.05})
        DATAMGR.do_set_attributes([1, -1],
                                            {'voltage_dc_operating': 3.3})
        DATAMGR.do_set_attributes([1, -1],
                                            {'voltage_ac_operating': 0.04})
        DATAMGR.do_set_attributes([1, -1], {'voltage_rated': 6.25})
        DATAMGR.do_set_attributes([1, -1],
        ...
        DATAMGR.do_set_attributes([1, -1], {'quantity': 1})
        DATAMGR.do_set_attributes([1, -1], {'cost_type_id': 2})
        DATAMGR.do_set_attributes([1, -1], {'cost': 1.35})
        DATAMGR.do_set_attributes([1, -1], {'part': 1})
        DATAMGR.do_update(1)
...
class TestStressCalculations():
    ...
    def test_do_calculate_part_zero_rated_current(
        ...
        DATAMGR.do_set_attributes([2, -1],
                                            {'hazard_rate_method_id': 2})
        DATAMGR.do_set_attributes([2, -1], {'category_id': 1})
        DATAMGR.do_set_attributes([2, -1],
                                            {'current_operating': 0.005})
        DATAMGR.do_set_attributes([2, -1], {'current_rated': 0.0})
    ...
    def test_do_calculate_power_ratio(self, mock_program_dao,
        ...
        DUT._attributes['power_rated'] = 0.5

        assert DUT._do_calculate_power_ratio() is None
        assert DUT._attributes['power_ratio'] == 0.4
    ...
    def test_do_calculate_power_ratio_zero_rated(self, mock_program_dao,
        ...
        DUT._attributes['hardware_id'] = 1
        DUT._attributes['category_id'] = 3
        DUT._attributes['power_operating'] = 0.2
        DUT._attributes['power_rated'] = 0.0
        DUT._request_do_stress_analysis()
    ...
    def test_do_calculate_part_zero_rated_voltage(
        ...
        DUT._attributes['hardware_id'] = 1
        DUT._attributes['voltage_ac_operating'] = 0.002
        DUT._attributes['voltage_dc_operating'] = 0.25
        DUT._attributes['voltage_rated'] = 5.0

        assert DUT._do_calculate_voltage_ratio() is None
        assert DUT._attributes['voltage_ratio'] == 0.0504
    ...
    def test_do_calculate_part_zero_rated_voltage(
        ...
        DUT._attributes['voltage_ac_operating'] = 0.002
        DUT._attributes['voltage_dc_operating'] = 0.25
        DUT._attributes['voltage_rated'] = 0.0
        DUT._do_calculate_voltage_ratio()
...
class TestAllocation():
    ...
    def on_fail_calculate_arinc_weight_factor(self, error_message):
        assert error_message == ('Failed to allocate the reliability for '
                                 'hardware ID 2; zero hazard rate.')
        print("\033[35m\nfail_calculate_arinc_weight_factor topic was "
              "broadcast")
    ...
    def test_do_calculate_arinc_allocation_zero_parent_hazard_rate(
        ...
        pub.subscribe(self.on_fail_calculate_arinc_weight_factor,
        ...
        pub.unsubscribe(self.on_fail_calculate_arinc_weight_factor,
                        'fail_calculate_arinc_weight_factor')
