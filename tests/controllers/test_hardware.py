...
class TestCreateControllers():
    ...
    @pytest.mark.unit
    def test_data_manager_create(self, test_program_dao):
        """__init__() should return a Hardware data manager."""
        DUT = dmHardware(test_program_dao)
    ...
    def test_analysis_manager_create(self, test_user_configuration):
        ...
        DUT = amHardware(test_user_configuration)
...
class TestGetterSetter():
    ...
    @pytest.mark.integration
    def test_on_get_tree(self, test_program_dao, test_user_configuration):
    ...
    def test_do_get_allocation_goal(self, test_program_dao, test_user_configuration,
                                    method_id):
...
class TestAnalysisMethods():
    ...
    def test_do_calculate_assembly_specified_hazard_rate(
            self, test_program_dao, test_user_configuration):
    ...
    def test_do_calculate_assembly_zero_hazard_rates(self, test_program_dao,
        ...
        DATAMGR = dmHardware(test_program_dao)
        DATAMGR.do_select_all(revision_id=1)
        amHardware(test_user_configuration)
