...
class TestFilterModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._dic_lambda_b = {1: [0.022, 0.044, 0.13, 0.088, 0.20, 0.15, 0.20, 0.24, 0.29, 0.24, 0.018, 0.15, 0.33, 2.6],
        ...
        for environment_active_id in xrange(1, 14):
            ...
            for quality_id in xrange(1, 3):
                ...
                for type_id in xrange(1, 3):
                    ...
                    _lambda_b = self._dic_lambda_b[type_id][environment_active_id - 1]
