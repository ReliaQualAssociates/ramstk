...
from rtk.analyses.prediction import Component, Inductor
...
def test_calculate_mil_hdbk_217f_part_count(subcategory_id, family_id,
...
def test_voltage_overstress_harsh_environment(voltage_rated,
    ...
    if voltage_rated == 20.0:
        ...
        assert _attributes['reason'] == ('1. Operating voltage > 50% rated '
...
def test_current_overstress_harsh_environment(current_rated,
    ...
    if current_rated == 1.0:
        ...
        assert _attributes['overstress']
        assert _attributes['reason'] == ('1. Operating current > 60% rated '
