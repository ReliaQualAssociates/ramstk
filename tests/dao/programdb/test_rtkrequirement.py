...
def test_rtkrequirement_create(test_dao):
    ...
    DUT = _session.query(RTKRequirement).first()

    assert isinstance(DUT, RTKRequirement)
...
def test_set_attributes(test_dao):
    ...
    assert _msg == ("RTK SUCCESS: Updating RTKRequirement {0:d} "
...
def test_set_attributes_missing_key(test_dao):
    ...
    assert _msg == ("RTK ERROR: Missing attribute 'q_clarity_1' in attribute "
