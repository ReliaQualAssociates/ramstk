...
def test_set_attributes(test_dao):
    ...
    assert _msg == ("RAMSTK SUCCESS: Updating RAMSTKMilHdbkF {0:d} "
...
def test_set_attributes_missing_key(test_dao):
    ...
    assert _msg == ("RAMSTK ERROR: Missing attribute 'B1' in attribute "
                    "dictionary passed to RAMSTKMilHdbkF.set_attributes().")
