...
\CheckBox[name=revisioninsert,charsize=12pt]{Inserting a revision also inserts an associated failure definition.} \\
\CheckBox[name=revisioninsert,charsize=12pt]{Inserting a revision also inserts an associated mission.} \\
\CheckBox[name=revisioninsert,charsize=12pt]{Selecting the new revision results in the new associated failure definition and mission to load into the list view.} \\
