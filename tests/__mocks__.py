...
MOCK_HRDWR_TREE.create_node(tag="hardware", identifier=0, parent=None, data=None)
...
MOCK_HRDWR_TREE.create_node(tag="S1:SS1:A2:C1", identifier=8, parent=7, data=None)
