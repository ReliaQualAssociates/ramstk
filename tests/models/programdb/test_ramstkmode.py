...
class TestRAMSTKMode:
    ...
    def test_ramstkmode_create(self, test_program_dao):
        ...
        assert DUT.description == "System Test Failure Mode #1"
        ...
        assert DUT.effect_probability == 1.0
    ...
    def test_get_attributes(self, test_program_dao):
        ...
        assert _attributes["description"] == "System Test Failure Mode #1"
        ...
        assert _attributes["mode_op_time"] == 10.0
        ...
        assert _attributes["severity_class"] == "IV"
