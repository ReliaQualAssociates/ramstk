...
class TestDeleteMethods:
    ...
    def on_fail_delete_non_existent_id(self, error_message):
        ...
        print("\033[35m\nfail_delete_control topic was broadcast on non-existent ID.")

    def on_fail_delete_not_in_tree(self, error_message):
        assert error_message == ("Attempted to delete non-existent Control ID 4.")
        print("\033[35m\nfail_delete_control topic was broadcast on not in tree.")
...
class TestUpdateMethods:
    ...
    def on_fail_update_wrong_data_type(self, error_message):
        ...
        print("\033[35m\nfail_update_control topic was broadcast on wrong data type.")
    ...
    def on_fail_update_non_existent_id(self, error_message):
        ...
        print("\033[35m\nfail_update_control topic was broadcast on non-existent ID.")

    def on_fail_update_no_data_package(self, error_message):
        assert error_message == ("do_update: No data package found for control ID 3.")
        print("\033[35m\nfail_update_control topic was broadcast on no data package.")
    ...
    def test_do_update(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(3).data["control"].type_id = "Detection"
        pub.sendMessage("request_update_control", node_id=3)
    ...
    def test_do_update_all(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(3).data["control"].type_id = "Prevention"
        ...
        assert test_tablemodel.tree.get_node(3).data["control"].type_id == "Prevention"
        assert (
            test_tablemodel.tree.get_node(4).data["control"].description
    ...
    def test_do_update_wrong_data_type(self, test_tablemodel):
        ...
        _control = test_tablemodel.do_select(3)
    ...
    def test_do_update_root_node_wrong_data_type(self, test_tablemodel):
        ...
        _control = test_tablemodel.do_select(4)
        _control.rpn_detection_new = {1: 2}
        pub.sendMessage("request_update_control", node_id=0)
    ...
    def test_do_update_non_existent_id(self):
        ...
        pub.sendMessage("request_update_control", node_id=100)
    ...
    def test_do_update_no_data_package(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(3).data.pop("control")
        pub.sendMessage("request_update_control", node_id=3)
...
class TestGetterSetter:
    ...
    def on_succeed_get_data_manager_tree(self, tree):
        ...
        assert isinstance(tree.get_node(4).data["control"], RAMSTKControlRecord)
    ...
    def test_do_set_attributes(self, test_tablemodel):
        ...
        assert test_tablemodel.do_select(4).type_id == "Detection"

        pub.unsubscribe(self.on_succeed_set_attributes, "succeed_get_control_tree")

    @pytest.mark.integration
    def test_do_set_attributes_no_package(self, test_tablemodel):
        """should set the value of the requested attribute."""
        test_tablemodel.tree.get_node(4).data.pop("control")
