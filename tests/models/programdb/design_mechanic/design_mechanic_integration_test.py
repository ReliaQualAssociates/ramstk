...
class TestSelectMethods:
    ...
    def on_succeed_select_all(self, tree):
        ...
        print("\033[36m\n\tsucceed_retrieve_all_design_mechanic topic was broadcast.")
    ...
    def test_do_select_all_populated_tree(self, test_attributes, test_table_model):
        ...
        pub.subscribe(
            self.on_succeed_select_all, "succeed_retrieve_all_design_mechanic"
        )
...
class TestInsertMethods:
    """Class for testing the do_insert() method."""
...
class TestDeleteMethods:
    ...
    def test_do_delete(self, test_table_model, test_hardware_table):
        ...
        assert isinstance(
            test_table_model.tree.get_node(8).data["design_mechanic"],
            RAMSTKDesignMechanicRecord,
        )
