...
class TestSelectMethods:
    ...
    def on_succeed_select_all(self, tree):
        ...
        print("\033[36m\nsucceed_retrieve_all_opstress topic was broadcast.")
    ...
    def test_do_select_all_populated_tree(self, test_attributes, test_tablemodel):
        ...
        pub.subscribe(self.on_succeed_select_all, "succeed_retrieve_all_opstress")

        pub.sendMessage("selected_revision", attributes=test_attributes)

        pub.unsubscribe(self.on_succeed_select_all, "succeed_retrieve_all_opstress")
...
class TestUpdateMethods:
    ...
    def test_do_update_all(self, test_tablemodel):
        ...
        pub.subscribe(self.on_succeed_update_all, "succeed_update_all_opstress")

        pub.sendMessage("request_update_all_opstress")

        pub.unsubscribe(self.on_succeed_update_all, "succeed_update_all_opstress")
...
class TestGetterSetter:
    ...
    def test_do_get_attributes(self, test_tablemodel):
        ...
        pub.sendMessage("request_get_opstress_attributes", node_id=3)
