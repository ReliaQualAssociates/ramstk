...
class TestRAMSTKIncidentAction(unittest.TestCase):
    ...
    def test00_ramstkincidentaction_create(self):
        ...
        self.assertEqual(self.DUT.approved_date, date.today() + timedelta(days=30))
        self.assertEqual(self.DUT.closed, 0)
        self.assertEqual(self.DUT.closed_by, 0)
        self.assertEqual(self.DUT.closed_date, date.today() + timedelta(days=30))
    ...
    def test02a_set_attributes(self):
        ...
        self.assertEqual(
            _msg,
            "RAMSTK SUCCESS: Updating RAMSTKIncidentAction "
