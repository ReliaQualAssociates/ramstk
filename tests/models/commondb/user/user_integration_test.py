...
class TestSelectUser(SystemTestSelectMethods):
    ...
    _do_select_msg = "request_select_user"
...
class TestUpdateUser:
    ...
    def test_do_update(self, integration_test_table_model):
        ...
        integration_test_table_model.tree.get_node(1).data["user"].user_lname = "Ann"
        integration_test_table_model.tree.get_node(1).data["user"].user_fname = "Lisa"
        integration_test_table_model.do_update(1)

        pub.unsubscribe(self.on_succeed_update, "succeed_update_user")

        assert (
            integration_test_table_model.tree.get_node(1).data["user"].user_lname
            == "Ann"
        )
        assert (
            integration_test_table_model.tree.get_node(1).data["user"].user_fname
            == "Lisa"
        )
    ...
    def test_do_update_all(self, integration_test_table_model):
        ...
        pub.subscribe(self.on_succeed_update_all, "succeed_update_all_user")

        pub.sendMessage("request_update_all_user")

        pub.unsubscribe(self.on_succeed_update_all, "succeed_update_all_user")
    ...
    def test_do_update_wrong_data_type(self, integration_test_table_model):
        ...
        integration_test_table_model.tree.get_node(1).data["user"].user_phone = None
        integration_test_table_model.do_update(1)
    ...
    def test_do_update_root_node_wrong_data_type(self, integration_test_table_model):
        ...
        integration_test_table_model.tree.get_node(1).data["user"].user_email = None
    ...
    def test_do_update_non_existent_id(self, integration_test_table_model):
        ...
        integration_test_table_model.do_select_all({"user_id": 1})
    ...
    def test_do_update_no_data_package(self, integration_test_table_model):
        ...
        integration_test_table_model.tree.get_node(1).data.pop("user")
        integration_test_table_model.do_update(1)
