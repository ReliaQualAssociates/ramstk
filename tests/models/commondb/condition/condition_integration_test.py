...
class TestSelectMethods:
    ...
    def on_succeed_select_all(self, tree):
        ...
        assert isinstance(tree.get_node(1).data["condition"], RAMSTKConditionRecord)
        ...
        print("\033[36m\nsucceed_retrieve_condition topic was broadcast.")

    @pytest.mark.integration
    def test_do_select_all_populated_tree(self, test_tablemodel):
        """do_select_all() should clear nodes from an existing Condition tree."""
        pub.subscribe(self.on_succeed_select_all, "succeed_retrieve_condition")

        test_tablemodel.do_select_all({"condition_id": 1})

        pub.unsubscribe(self.on_succeed_select_all, "succeed_retrieve_condition")
...
class TestUpdateMethods:
    ...
    def on_fail_update_wrong_data_type(self, error_message):
        assert error_message == (
            "do_update: The value for one or more attributes for condition ID 1 was "
            "the wrong type."
        )
        print("\033[35m\nfail_update_condition topic was broadcast on wrong type.")

    def on_fail_update_root_node_wrong_data_type(self, error_message):
        assert error_message == "do_update: Attempting to update the root node 0."
        print("\033[35m\nfail_update_condition topic was broadcast on root node.")

    def on_fail_update_non_existent_id(self, error_message):
        assert error_message == (
            "do_update: Attempted to save non-existent condition with condition ID "
            "skullduggery."
        )
        print("\033[35m\nfail_update_condition topic was broadcast on non-existent ID.")

    def on_fail_update_no_data_package(self, error_message):
        assert error_message == "do_update: No data package found for condition ID 1."
        print("\033[35m\nfail_update_condition topic was broadcast on no data package.")
    ...
    def test_do_update(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(1).data["condition"].description = "New Condition"
        ...
        assert (
            test_tablemodel.tree.get_node(1).data["condition"].description
            == "New Condition"
        )
        assert (
            test_tablemodel.tree.get_node(1).data["condition"].condition_type
            == "not_good_type"
        )

        test_tablemodel.tree.get_node(1).data["condition"].description = "Cavitation"
        test_tablemodel.tree.get_node(1).data["condition"].condition_type = "operating"
        test_tablemodel.do_update(1)
    ...
    def test_do_update_wrong_data_type(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(1).data["condition"].condition_type = None
        test_tablemodel.do_update(1)
    ...
    def test_do_update_root_node_wrong_data_type(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(1).data["condition"].condition_type = "Hey bud"
    ...
    def test_do_update_non_existent_id(self, test_tablemodel):
        """do_update() should return a non-zero error code when passed a Condition ID
        that doesn't exist."""
    ...
    def test_do_update_no_data_package(self, test_tablemodel):
        ...
        test_tablemodel.tree.get_node(1).data.pop("condition")
        test_tablemodel.do_update(1)
...
class TestGetterSetter:
    ...
    def on_succeed_get_attributes(self, attributes):
        ...
        print("\033[36m\nsucceed_get_condition_attributes topic was broadcast.")

    def on_succeed_get_data_manager_tree(self, tree):
        assert isinstance(tree, Tree)
        assert isinstance(tree.get_node(1).data["condition"], RAMSTKConditionRecord)
        print("\033[36m\nsucceed_get_condition_tree topic was broadcast")

    def on_succeed_set_attributes(self, tree):
        assert isinstance(tree, Tree)
        assert tree.get_node(1).data["condition"].condition_type == "new_condition_type"
        assert tree.get_node(1).data["condition"].description == "for a new condition"
        print("\033[36m\nsucceed_get_condition_tree topic was broadcast")
    ...
    def test_do_get_attributes(self, test_tablemodel):
        ...
        success."""
        pub.subscribe(
            self.on_succeed_get_attributes, "succeed_get_condition_attributes"
        )

        pub.sendMessage(
            "request_get_condition_attributes2", attributes={"condition_id": 1}
        )
    ...
    def test_on_get_data_manager_tree(self, test_tablemodel):
        """on_get_tree() should return the Condition treelib Tree."""
        pub.subscribe(
            self.on_succeed_get_data_manager_tree, "succeed_get_condition_tree"
        )

        pub.sendMessage("request_get_condition_tree")
    ...
    def test_do_set_attributes(self, test_tablemodel):
        ...
        pub.sendMessage(
            "request_set_condition_attributes",
            node_id=1,
            package={"condition_type": "new_condition_type"},
        )

        pub.subscribe(self.on_succeed_set_attributes, "succeed_get_condition_tree")

        pub.sendMessage(
            "request_set_condition_attributes",
            node_id=1,
            package={"description": "for a new condition"},
        )

        pub.unsubscribe(self.on_succeed_set_attributes, "succeed_get_condition_tree")
