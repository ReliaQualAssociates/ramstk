...
class TestSelectStakeholders(SystemTestSelectMethods):
    ...
    _do_select_msg = "request_select_stakeholders"
...
class TestUpdateStakeholders:
    ...
    def test_do_update_non_existent_id(self, integration_test_table_model):
        ...
        integration_test_table_model.do_select_all({"stakeholders_id": 1})
    ...
    def test_do_update_no_data_package(self, integration_test_table_model):
        ...
        integration_test_table_model.tree.get_node(1).data.pop("stakeholders")
        integration_test_table_model.do_update(1)
