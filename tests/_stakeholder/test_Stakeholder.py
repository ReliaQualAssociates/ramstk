...
class TestStakeholderDataModel(unittest.TestCase):
    """Class for testing the Stakeholder data model class."""

    def setUp(self):
        """Set up the test fixture for the Stakeholder class."""
        ...
        self.DUT = dtmStakeholder(self.dao)

    @attr(all=True, unit=True)
    def test00_create(self):
        """(TestStakeholderModel) __init__ should return a Stakeholder model."""
        self.assertTrue(isinstance(self.DUT, dtmStakeholder))
    ...
    def test02a_select(self):
        ...
        self.assertEqual(_stakeholder.description, 'Stakeholder Input')
    ...
    def test07a_calculate_weight(self):
        """(TestStakeholderModel) calculate_weight returns False on success and calculate values are correct."""
        self.DUT.select_all(1)
        _stakeholder = self.DUT.select(1)
...
class TestStakeholderDataController(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.DUT = dtcStakeholder(self.dao, self.Configuration, test='True')

    @attr(all=True, unit=True)
    def test00_controller_create(self):
        """(TestStakeholderController) __init__ should create a Stakeholder data controller."""
        self.assertTrue(isinstance(self.DUT, dtcStakeholder))
        # pylint: disable=protected-access
        self.assertTrue(isinstance(self.DUT._dtm_data_model, dtmStakeholder))
