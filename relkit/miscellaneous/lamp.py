#!/usr/bin/env python
""" This is the electric lamp class. """
...
# -*- coding: utf-8 -*-
#
#       lamp.py is part of The RelKit Project
#
# All rights reserved.
...
class Lamp:
    ...
    Hazard Rate Models:
        1. MIL-HDBK-217F, section 20.1
    """

    _application = [u"", u"Alternating Current", "Direct Current"]
    ...
    def __init__(self):
        ...
        self.subcategory = 81               # Subcategory in reliafreecom database.
        ...
        self._in_labels.append(u"Utilization (Illuminate Hours/Operate Hours):")
        self._in_labels.append(u"Application:")
        self._in_labels.append(u"Rated Voltage (V):")

        self._out_labels.append(u"<span foreground=\"blue\">\u03BB<sub>p</sub> = \u03BB<sub>b</sub>\u03C0<sub>U</sub>\u03C0<sub>A</sub>\u03C0<sub>E</sub></span>")
