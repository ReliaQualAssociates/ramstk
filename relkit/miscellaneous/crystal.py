...
# -*- coding: utf-8 -*-
#
#       crystal.py is part of The RelKit Project
#
# All rights reserved.
...
class Crystal:
    ...
    def __init__(self):
        ...
        self._in_labels.append(u"Frequency:")
    ...
    def assessment_inputs_create(self, part, layout, x_pos, y_pos):
        ...
        part.txtFrequency.connect("focus-out-event",
                                  self.entry_callback,
                                  part, "float", 63)
        layout.put(part.txtFrequency, x_pos, y_pos)
    ...
    def assessment_inputs_load(self, part):
        ...
        part.txtFrequency.set_text(str(part.model.get_value(part.selected_row, 63)))
    ...
    def combo_callback(self, combo, part, _index_):
        ...
        treemodel.set_value(row, _index_, int(idx))
    ...
    def entry_callback(self, entry, event, part, convert, _index_):
        ...
        if(convert == "text"):
            treemodel.set_value(row, _index_, entry.get_text())

        elif(convert == "int"):
            treemodel.set_value(row, _index_, int(entry.get_text()))

        elif(convert == "float"):
            treemodel.set_value(row, _index_, float(entry.get_text()))
        ...
        if(_index_ == 79):
            ...
            if(CpiQ > 0):
                treemodel.set_value(row, 79, CpiQ)
