...
# -*- coding: utf-8 -*-
#
#       pcb.py is part of The RelKit Project
#
# All rights reserved.
...
class PCBEdge(Connection):
    ...
    Hazard Rate Models:
        1. MIL-HDBK-217F, section 15.2.
    """

    _awg = [u"", u"26", u"22", u"20"]
    ...
    def __init__(self):
        ...
        self.subcategory = 73                   # Subcategory ID in reliafreecom database.
    ...
    def assessment_inputs_load(self, part):
        ...
        part.txtActivePins.set_text(str('{0:0.0g}'.format(partmodel.get_value(partrow, 57))))
