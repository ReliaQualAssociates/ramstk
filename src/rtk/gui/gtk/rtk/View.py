...
class RTKBaseView(object):
    ...
    def set_cursor(self, cursor):
        ...
        :rtype: None
        """
        self._mdcRTK.dic_books['listbook'].get_window().set_cursor(
            gtk.gdk.Cursor(cursor))
        self._mdcRTK.dic_books['modulebook'].get_window().set_cursor(
            gtk.gdk.Cursor(cursor))
        self._mdcRTK.dic_books['workbook'].get_window().set_cursor(
            gtk.gdk.Cursor(cursor))
