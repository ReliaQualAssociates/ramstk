# -*- coding: utf-8 -*-
#
#       rtk.gui.gtk.matrixviews.ValidationRequirement.py is part of the RAMSTK
#       Project
#
# All rights reserved.
# Copyright 2007 - 2017 Andrew Rowland andrew.rowland <AT> reliaqual <DOT> com
"""The Validation:Requirement Matrix View Module."""
...
class MatrixView(gtk.HBox, rtk.RAMSTKBaseMatrix):
    """
    This is the Validation:Requirement RAMSTK Matrix View.

    Attributes of the Validation:Requirement Matrix View are:
    """

    def __init__(self, controller, **kwargs):
        """
        Initialize the Validation:Requirement Matrix View.
        ...
        _label.set_tooltip_text(
            _(u"Displays validation/requirement matrix for the "
              u"selected revision."))
    ...
    def _make_buttonbox(self, **kwargs):  # pylint: disable=unused-argument
        """
        Create the buttonbox for the Validation:Requirement Matrix View.

        :return: _buttonbox; the gtk.ButtonBox() for the Validation:Requirement
                             Matrix View.
        :rtype: :py:class:`gtk.ButtonBox`
        """
        _tooltips = [
            _(u"Save the Validation:Requirement Matrix to the open RAMSTK "
              u"Program database."),
            _(u'Create or refresh the Validation:Requirement Matrix.')
        ]
    ...
    def _on_select_revision(self, module_id):
        """
        Load the Validation:Requirement Matrix View with matrix information.

        :param int revision_id: the Revision ID to select the
                                Validation:Requirement matrix for.
        :return: None
        :rtype: None
        """
        ...
        if _matrix is not None:
            _return = rtk.RAMSTKBaseMatrix.do_load_matrix(self, _matrix,
