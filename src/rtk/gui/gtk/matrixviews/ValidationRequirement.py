# -*- coding: utf-8 -*-
#
#       rtk.gui.gtk.matrixviews.ValidationRequirement.py is part of the RTK
#       Project
#
# All rights reserved.
...
class MatrixView(gtk.HBox, rtk.RTKBaseMatrix):
    """
    This is the Validation:Requirement RTK Matrix View.
    ...
    def _make_buttonbox(self, **kwargs):  # pylint: disable=unused-argument
        ...
        """
        _tooltips = [
            _(u"Save the Validation:Requirement Matrix to the open RTK "
              u"Program database."),
    ...
    def _on_select_revision(self, module_id):
        ...
        if _matrix is not None:
            _return = rtk.RTKBaseMatrix.do_load_matrix(self, _matrix,
