# -*- coding: utf-8 -*-
#
#       rtk.dao.RAMSTKMilHdbkF.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKMilHdbkF(RAMSTK_BASE):
    """
    Class to represent the rtk_mil_hdbk_f table in the RAMSTK Program database.
    ...
    def set_attributes(self, attributes):
        ...
        """
        _error_code = 0
        _msg = "RAMSTK SUCCESS: Updating RAMSTKMilHdbkF {0:d} attributes.". \
