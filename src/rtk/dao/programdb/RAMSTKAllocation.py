# -*- coding: utf-8 -*-
#
#       rtk.dao.RAMSTKAllocation.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKAllocation(RAMSTK_BASE):
    """
    Class to represent the rtk_allocation table in the RAMSTK Program database.
    ...
    def set_attributes(self, attributes):
        ...
        try:
            ...
            _msg = "RAMSTK ERROR: Missing attribute {0:s} in attribute " \
                   ...
                   "RAMSTKAllocation.set_attributes().".format(_err)
