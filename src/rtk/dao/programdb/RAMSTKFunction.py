# -*- coding: utf-8 -*-
#
#       rtk.dao.RAMSTKFunction.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKFunction(RAMSTK_BASE):
    """
    Class to represent the rtk_function table in the RAMSTK Program database.
    ...
    def set_attributes(self, values):
        ...
        try:
            ...
            _msg = "RAMSTK ERROR: Missing attribute {0:s} in attribute " \
                   ...
                   "RAMSTKFunction.set_attributes().".format(_err)
