# -*- coding: utf-8 -*-
#
#       rtk.dao.RAMSTKRequirement.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKRequirement(RAMSTK_BASE):
    """
    Class to represent the rtk_requirement table in the RAMSTK Program database.
    ...
    def set_attributes(self, attributes):
        ...
        """
        _error_code = 0
        _msg = "RAMSTK SUCCESS: Updating RAMSTKRequirement {0:d} attributes.". \
