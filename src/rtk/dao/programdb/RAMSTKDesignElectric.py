# -*- coding: utf-8 -*-
#
#       rtk.dao.RAMSTKDesignElectric.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKDesignElectric(RAMSTK_BASE):
    """
    Represent the rtk_design_electric table in the RAMSTK Program database.
    ...
    def get_attributes(self):
        """
        Retrieve current values of the RAMSTKDesignElectric data model attributes.
