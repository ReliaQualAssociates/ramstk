...
# -*- coding: utf-8 -*-
#
#       rtk.RAMSTK.py is part of the RAMSTK Project
#
# All rights reserved.
...
from rtk.dao.commondb.RAMSTKLoadHistory import RAMSTKLoadHistory
...
from rtk.dao.commondb.RAMSTKMethod import RAMSTKMethod
...
from rtk.dao.commondb.RAMSTKType import RAMSTKType
from rtk.dao.commondb.RAMSTKUser import RAMSTKUser
from rtk.dao.commondb.RAMSTKRPN import RAMSTKRPN
...
class RAMSTK(object):
    ...
    def request_do_load_globals(self):
        ...
        :rtype: bool
        """
        return self.rtk_model.do_load_globals(self.RAMSTK_CONFIGURATION)
