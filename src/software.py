...
# Create the Risk Analysis tab widgets.
    ...
    lblSRRQ50 = _widg.make_label(_srr_labels_[4][3], width=500, height=-1,
                                 bold=False)
    txtSRRQ41 = _widg.make_entry(width=50)
    txtSRRQ42 = _widg.make_entry(width=50)
    txtSRRQ43 = _widg.make_entry(width=50)
    txtSRRQ44 = _widg.make_entry(width=50)
    txtSRRQ45 = _widg.make_entry(width=50)
    txtSRRQ46 = _widg.make_entry(width=50)
    txtSRRQ47 = _widg.make_entry(width=50)
    txtSRRQ48 = _widg.make_entry(width=50)
    txtSRRQ49 = _widg.make_entry(width=50)
    txtSRRQ50 = _widg.make_entry(width=50)
    ...
    lblPDRQ39 = _widg.make_label(_pdr_labels_[3][9], width=500, height=-1,
                                 bold=False)
    txtPDRQ30 = _widg.make_entry(width=50)
    txtPDRQ31 = _widg.make_entry(width=50)
    txtPDRQ32 = _widg.make_entry(width=50)
    txtPDRQ33 = _widg.make_entry(width=50)
    txtPDRQ34 = _widg.make_entry(width=50)
    txtPDRQ35 = _widg.make_entry(width=50)
    txtPDRQ36 = _widg.make_entry(width=50)
    txtPDRQ37 = _widg.make_entry(width=50)
    txtPDRQ38 = _widg.make_entry(width=50)
    txtPDRQ39 = _widg.make_entry(width=50)
    ...
    lblCDRQ34 = _widg.make_label(_cdr_labels_[2][23], width=500, height=-1,
                                 bold=False)
    txtCDRQ11 = _widg.make_entry(width=50)
    txtCDRQ12 = _widg.make_entry(width=50)
    txtCDRQ13 = _widg.make_entry(width=50)
    txtCDRQ14 = _widg.make_entry(width=50)
    txtCDRQ15 = _widg.make_entry(width=50)
    txtCDRQ16 = _widg.make_entry(width=50)
    txtCDRQ17 = _widg.make_entry(width=50)
    txtCDRQ18 = _widg.make_entry(width=50)
    txtCDRQ19 = _widg.make_entry(width=50)
    txtCDRQ20 = _widg.make_entry(width=50)
    txtCDRQ21 = _widg.make_entry(width=50)
    txtCDRQ22 = _widg.make_entry(width=50)
    txtCDRQ23 = _widg.make_entry(width=50)
    txtCDRQ24 = _widg.make_entry(width=50)
    txtCDRQ25 = _widg.make_entry(width=50)
    txtCDRQ26 = _widg.make_entry(width=50)
    txtCDRQ27 = _widg.make_entry(width=50)
    txtCDRQ28 = _widg.make_entry(width=50)
    txtCDRQ29 = _widg.make_entry(width=50)
    txtCDRQ30 = _widg.make_entry(width=50)
    txtCDRQ31 = _widg.make_entry(width=50)
    txtCDRQ32 = _widg.make_entry(width=50)
    txtCDRQ33 = _widg.make_entry(width=50)
    txtCDRQ34 = _widg.make_entry(width=50)
    ...
    lblCDRQ58 = _widg.make_label(_cdr_labels_[4][11], width=500, height=-1,
                                 bold=False)
    txtCDRQ47 = _widg.make_entry(width=50)
    txtCDRQ48 = _widg.make_entry(width=50)
    txtCDRQ49 = _widg.make_entry(width=50)
    txtCDRQ50 = _widg.make_entry(width=50)
    txtCDRQ51 = _widg.make_entry(width=50)
    txtCDRQ52 = _widg.make_entry(width=50)
    txtCDRQ53 = _widg.make_entry(width=50)
    txtCDRQ54 = _widg.make_entry(width=50)
    txtCDRQ55 = _widg.make_entry(width=50)
    txtCDRQ56 = _widg.make_entry(width=50)
    ...
    lblTRRQ24 = _widg.make_label(_trr_labels_[3][3], width=500, height=-1,
                                 bold=False)
    txtTRRQ1 = _widg.make_entry(width=50)
    txtTRRQ2 = _widg.make_entry(width=50)
    txtTRRQ3 = _widg.make_entry(width=50)
    txtTRRQ4 = _widg.make_entry(width=50)
    txtTRRQ21 = _widg.make_entry(width=50)
    txtTRRQ22 = _widg.make_entry(width=50)
...
# Test Technique Selection tab widgets.
        ...
        self.txtLaborTest = _widg.make_entry(width=100)
        self.txtLaborDev = _widg.make_entry(width=100)
        self.txtBudgetTest = _widg.make_entry(width=100)
        self.txtBudgetDev = _widg.make_entry(width=100)
        self.txtScheduleTest = _widg.make_entry(width=100)
        self.txtScheduleDev = _widg.make_entry(width=100)
        self.txtBranches = _widg.make_entry(width=100)
        self.txtBranchesTest = _widg.make_entry(width=100)
        self.txtInputs = _widg.make_entry(width=100)
        self.txtInputsTest = _widg.make_entry(width=100)
        self.txtUnits = _widg.make_entry(width=100)
        self.txtUnitsTest = _widg.make_entry(width=100)
        self.txtInterfaces = _widg.make_entry(width=100)
        self.txtInterfacesTest = _widg.make_entry(width=100)
