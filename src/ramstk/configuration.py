...
class RAMSTKUserConfiguration:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self) -> None:
        ...
        self.RAMSTK_DAMAGE_MODELS: Dict[int, Tuple[str]] = {}  # User.
        ...
        self.RAMSTK_LOAD_HISTORY: Dict[int, Tuple[str]] = {}  # User.
        ...
        self.RAMSTK_RPN_DETECTION: Dict[int, Tuple[str]] = {}  # User.
        self.RAMSTK_RPN_OCCURRENCE: Dict[int, Tuple[str]] = {}  # User.
        self.RAMSTK_RPN_SEVERITY: Dict[int, Tuple[str]] = {}  # User.
        self.RAMSTK_SEVERITY: Dict[str, Tuple[str, str, str, str]] = {}  # Admin
        self.RAMSTK_STAKEHOLDERS: Dict[int, Tuple[str]] = {}  # User.
