# -*- coding: utf-8 -*-
#
#       ramstk.dao.RAMSTKGrowthTest.py is part of The RAMSTK Project
#
# All rights reserved.
# Copyright 2007 - 2017 Doyle Rowland doyle.rowland <AT> reliaqual <DOT> com
"""
===============================================================================
The RAMSTKGrowthTest Table
===============================================================================
"""
...
class RAMSTKGrowthTest(RAMSTK_BASE):
    """
    Class to represent the table ramstk_growth_test in the RAMSTK Program database.

    This table shares a Many-to-One relationship with ramstk_test.
    """

    __tablename__ = 'ramstk_growth_test'
    ...
    test = relationship('RAMSTKTest', back_populates='growth')

    def get_attributes(self):
        """
        Method to retrieve the current values of the RAMSTKGrowthTest data model
        attributes.
