# -*- coding: utf-8 -*-
#
#       ramstk.dao.RAMSTKDesignMechanic.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKDesignMechanic(RAMSTK_BASE):
    ...
    __tablename__ = 'ramstk_design_mechanic'  # pragma: no cover
    ...
    def get_attributes(self):
        """
        Retrieve current values of the RAMSTKDesignMechanic data model attributes.
    ...
    def set_attributes(self, attributes):
        ...
        try:
            ...
            _msg = "RAMSTK ERROR: Missing attribute {0:s} in attribute " \
                   ...
                   "RAMSTKDesignMechanic.set_attributes().".format(str(_err))
