# -*- coding: utf-8 -*-
#
#       ramstk.dao.RAMSTKSurvival.py is part of The RAMSTK Project
#
# All rights reserved.
# Copyright 2007 - 2017 Doyle Rowland doyle.rowland <AT> reliaqual <DOT> com
"""
===============================================================================
The RAMSTKSurvival Table
===============================================================================
"""
...
class RAMSTKSurvival(RAMSTK_BASE):
    """
    Class to represent the table ramstk_survival in the RAMSTK Program database.

    This table shares a Many-to-One relationship with ramstk_revision.
    This table shares a One-to-Many relatinship with ramstk_survival_data.
    """

    __tablename__ = 'ramstk_survival'
    ...
    revision = relationship('RAMSTKRevision', back_populates='survival')
    data = relationship('RAMSTKSurvivalData', back_populates='survival')

    def get_attributes(self):
        """
        Retrieves the current values of the RAMSTKSurvival data model attributes.
