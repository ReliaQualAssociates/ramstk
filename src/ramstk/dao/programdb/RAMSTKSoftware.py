# -*- coding: utf-8 -*-
#
#       ramstk.dao.RAMSTKSoftware.py is part of The RAMSTK Project
#
# All rights reserved.
# Copyright 2007 - 2017 Doyle Rowland doyle.rowland <AT> reliaqual <DOT> com
"""
===============================================================================
The RAMSTKSoftware Table
===============================================================================
"""
...
class RAMSTKSoftware(RAMSTK_BASE):
    """
    Class to represent the table ramstk_software in the RAMSTK Program database.

    This table shares a Many-to-One relationship with ramstk_revision.
    This table shares
    """

    __tablename__ = 'ramstk_software'
    ...
    def get_attributes(self):
        """
        Method to retrieve the current values of the RAMSTKSoftware data model
        attributes.
