# -*- coding: utf-8 -*-
#
#       ramstk.dao.RAMSTKSoftwareReview.py is part of The RAMSTK Project
#
# All rights reserved.
...
class RAMSTKSoftwareReview(RAMSTK_BASE):
    """
    Class to represent the table ramstk_software_review in the RAMSTK Program
    database.
    ...
    __tablename__ = 'ramstk_software_review'
