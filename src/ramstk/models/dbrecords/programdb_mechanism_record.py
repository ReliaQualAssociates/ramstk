...
class RAMSTKMechanismRecord(RAMSTK_BASE, RAMSTKBaseRecord):  # type: ignore
    ...
    This table shares a Many-to-One relationship with ramstk_mode. This table shares a
    One-to-Many relationship with ramstk_cause. This table shares a One- to-Many
    relationship with ramstk_op_load.
    """
    ...
    mode: Mapped[relationship] = relationship(
        "RAMSTKModeRecord",
