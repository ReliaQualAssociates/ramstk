...
class RAMSTKModeRecord(RAMSTK_BASE, RAMSTKBaseRecord):  # type: ignore
    ...
    critical_item = Column(
        "fld_critical_item", Integer, default=__defaults__["critical_item"]
    )
    description = Column(
    ...
    effect_local = Column(
        "fld_effect_local", String(512), default=__defaults__["effect_local"]
    )
    effect_next = Column(
    ...
    mode_criticality = Column(
        "fld_mode_criticality", Float, default=__defaults__["mode_criticality"]
    )
    mode_hazard_rate = Column(
        "fld_mode_hazard_rate", Float, default=__defaults__["mode_hazard_rate"]
    )
    mode_op_time = Column(
