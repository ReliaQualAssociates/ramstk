# -*- coding: utf-8 -*-
#
#       ramstk.models.dbrecords.commondb_site_info_record.py is part of the RAMSTK
#       Project
#
# All rights reserved.
...
class RAMSTKSiteInfoRecord(RAMSTK_BASE, RAMSTKBaseRecord):  # type: ignore
    ...
    fmea_enabled = Column(
        "fld_fmea_enabled", Integer, default=__defaults__["fmea_enabled"]
    )
    pof_enabled = Column(
        "fld_pof_enabled", Integer, default=__defaults__["pof_enabled"]
    )
    rbd_enabled = Column(
        "fld_rbd_enabled", Integer, default=__defaults__["rbd_enabled"]
    )
    fta_enabled = Column(
        "fld_fta_enabled", Integer, default=__defaults__["fta_enabled"]
    )
