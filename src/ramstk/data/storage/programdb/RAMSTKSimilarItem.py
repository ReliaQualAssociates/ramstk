...
class RAMSTKSimilarItem(RAMSTK_BASE):
    ...
    change_description_1 = Column(
        'fld_change_description_1', BLOB, default=__defaults__['change_description_1'],
    )
    change_description_2 = Column(
        'fld_change_description_2', BLOB, default=__defaults__['change_description_2'],
    )
    change_description_3 = Column(
        'fld_change_description_3', BLOB, default=__defaults__['change_description_3'],
    )
    change_description_4 = Column(
        'fld_change_description_4', BLOB, default=__defaults__['change_description_4'],
    )
    change_description_5 = Column(
        'fld_change_description_5', BLOB, default=__defaults__['change_description_5'],
    )
    change_description_6 = Column(
        'fld_change_description_6', BLOB, default=__defaults__['change_description_6'],
    )
    change_description_7 = Column(
        'fld_change_description_7', BLOB, default=__defaults__['change_description_7'],
    )
    change_description_8 = Column(
        'fld_change_description_8', BLOB, default=__defaults__['change_description_8'],
    )
    change_description_9 = Column(
        'fld_change_description_9', BLOB, default=__defaults__['change_description_9'],
    )
    change_description_10 = Column(
        'fld_change_description_10', BLOB, default=__defaults__['change_description_10'],
    )
    change_factor_1 = Column('fld_change_factor_1', Float, default=__defaults__['change_factor_1'])
    change_factor_2 = Column('fld_change_factor_2', Float, default=__defaults__['change_factor_2'])
    change_factor_3 = Column('fld_change_factor_3', Float, default=__defaults__['change_factor_3'])
    change_factor_4 = Column('fld_change_factor_4', Float, default=__defaults__['change_factor_4'])
    change_factor_5 = Column('fld_change_factor_5', Float, default=__defaults__['change_factor_5'])
    change_factor_6 = Column('fld_change_factor_6', Float, default=__defaults__['change_factor_6'])
    change_factor_7 = Column('fld_change_factor_7', Float, default=__defaults__['change_factor_7'])
    change_factor_8 = Column('fld_change_factor_8', Float, default=__defaults__['change_factor_8'])
    change_factor_9 = Column('fld_change_factor_9', Float, default=__defaults__['change_factor_9'])
    change_factor_10 = Column('fld_change_factor_10', Float, default=__defaults__['change_factor_10'])
    environment_from_id = Column('fld_environment_from_id', Integer, default=__defaults__['environment_from_id'])
    environment_to_id = Column('fld_environment_to_id', Integer, default=__defaults__['environment_to_id'])
    ...
    method_id = Column('fld_method_id', Integer, default=__defaults__['method_id'])
    parent_id = Column('fld_parent_id', Integer, default=__defaults__['parent_id'])
    quality_from_id = Column('fld_quality_from_id', Integer, default=__defaults__['quality_from_id'])
    quality_to_id = Column('fld_quality_to_id', Integer, default=__defaults__['quality_to_id'])
    ...
    temperature_from = Column('fld_temperature_from', Float, default=__defaults__['temperature_from'])
    temperature_to = Column('fld_temperature_to', Float, default=__defaults__['temperature_to'])
    ...
    user_blob_4 = Column('fld_user_blob_4', BLOB, default=__defaults__['user_blob_4'])
    user_blob_5 = Column('fld_user_blob_5', BLOB, default=__defaults__['user_blob_5'])
    ...
    user_float_4 = Column('fld_user_float_4', Float, default=__defaults__['user_float_4'])
    user_float_5 = Column('fld_user_float_5', Float, default=__defaults__['user_float_5'])
