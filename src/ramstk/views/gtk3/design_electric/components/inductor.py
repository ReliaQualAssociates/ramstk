...
class AssessmentInputPanel(RAMSTKAssessmentInputPanel):
    ...
    def __init__(self) -> None:
        ...
        self._lst_tooltips: List[str] = [
            ...
            _(
                "The case radiating surface (in square inches) of the inductive "
                "device."
            ),
        ...
        self._dic_attribute_updater = {
            ...
            "specification_id": [self.cmbSpecification.do_update, "changed", 4],
    ...
    def __set_callbacks(self) -> None:
        ...
        self.cmbInsulation.dic_handler_id["changed"] = self.cmbInsulation.connect(
    ...
    def __set_properties(self) -> None:
        ...
        # ----- ENTRIES
        self.txtArea.do_set_properties(tooltip=self._lst_tooltips[3], width=125)
        self.txtWeight.do_set_properties(tooltip=self._lst_tooltips[4], width=125)
