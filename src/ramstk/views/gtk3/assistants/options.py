...
class EditOptionsPanel(RAMSTKPanel):
    ...
    def _do_load_panel(self, attributes: Dict[str, Any]) -> None:
        ...
        self.txtSiteName.do_update(str(attributes["site_name"]), signal="changed")
        self.txtProductKey.do_update(str(attributes["product_key"]), signal="changed")
        self.txtExpireDate.do_update(str(attributes["expire_on"]), signal="changed")

        self.chkFunctions.do_update(
            int(attributes["function_enabled"]), signal="toggled"
        )
        self.chkRequirements.do_update(
            int(attributes["requirement_enabled"]), signal="toggled"
        )
        self.chkHardware.do_update(
            int(attributes["hardware_enabled"]), signal="toggled"
        )
        self.chkValidation.do_update(int(attributes["vandv_enabled"]), signal="toggled")
        self.chkHazards.do_update(int(attributes["hazard_enabled"]), signal="toggled")
        self.chkStakeholder.do_update(
            int(attributes["stakeholder_enabled"]), signal="toggled"
        )
        self.chkAllocation.do_update(
            int(attributes["allocation_enabled"]), signal="toggled"
        )
        self.chkSimilarItem.do_update(
            int(attributes["similar_item_enabled"]), signal="toggled"
        )
        self.chkFMEA.do_update(int(attributes["fmea_enabled"]), signal="toggled")
    ...
    def __do_set_callbacks(self) -> None:
        ...
        :rtype: None
        """
        self.chkFunctions.dic_handler_id["toggled"] = self.chkFunctions.connect(
            "toggled", super().on_toggled, 4, "request_set_option_attributes"
        )
        self.chkRequirements.dic_handler_id["toggled"] = self.chkRequirements.connect(
            "toggled", super().on_toggled, 5, "request_set_option_attributes"
        )
        self.chkHardware.dic_handler_id["toggled"] = self.chkHardware.connect(
            "toggled", super().on_toggled, 6, "request_set_option_attributes"
        )
        self.chkHazards.dic_handler_id["toggled"] = self.chkHazards.connect(
            "toggled", super().on_toggled, 13, "request_set_option_attributes"
        )
        self.chkStakeholder.dic_handler_id["toggled"] = self.chkStakeholder.connect(
            "toggled", super().on_toggled, 14, "request_set_option_attributes"
        )
        self.chkAllocation.dic_handler_id["toggled"] = self.chkAllocation.connect(
            "toggled", super().on_toggled, 15, "request_set_option_attributes"
        )
        self.chkSimilarItem.dic_handler_id["toggled"] = self.chkSimilarItem.connect(
            "toggled", super().on_toggled, 16, "request_set_option_attributes"
        )
        self.chkValidation.dic_handler_id["toggled"] = self.chkValidation.connect(
            "toggled", super().on_toggled, 12, "request_set_option_attributes"
        )
        self.chkFMEA.dic_handler_id["toggled"] = self.chkFMEA.connect(
            "toggled", super().on_toggled, 17, "request_set_option_attributes"
        )
        self.chkPoF.dic_handler_id["toggled"] = self.chkPoF.connect(
            "toggled", super().on_toggled, 18, "request_set_option_attributes"
        )
    ...
    def __do_set_properties(self) -> None:
        ...
        :rtype: None
        """
        self.txtSiteID.do_set_properties(can_focus=False, editable=False, width=100)
        self.txtSiteName.do_set_properties(can_focus=False, editable=False, width=300)
        self.txtProductKey.do_set_properties(can_focus=False, editable=False, width=300)
        self.txtExpireDate.do_set_properties(can_focus=False, editable=False, width=100)
