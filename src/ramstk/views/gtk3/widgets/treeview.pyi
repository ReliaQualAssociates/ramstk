...
def do_set_cell_properties(
    cell: object, properties: Dict[str, Any]
) -> None: ...
...
class RAMSTKTreeView(Gtk.TreeView, RAMSTKWidget):
    ...
    def do_get_row_by_value(
        self, search_col: int, value: Any
    ) -> Gtk.TreeIter: ...
    def do_insert_row(
        self, data: Dict[str, Any], prow: Gtk.TreeIter = ...
    ) -> None: ...
