...
class RAMSTKTreeView(Gtk.TreeView, RAMSTKWidget):
    ...
    def do_edit_cell(self, cell: Gtk.CellRenderer, path: str, new_text: Any, position: int) -> Any: ...
    ...
    def do_load_tree(self, tree: treelib.Tree, tag: str, row: Gtk.TreeIter=...) -> None: ...
