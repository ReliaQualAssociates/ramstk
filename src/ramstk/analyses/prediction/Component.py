...
def _get_environment_factor(**attributes):
    ...
    _dic_piE = {
        ...
        10: {
            ...
            2: [
                1.0, 2.0, 6.0, 4.0, 9.0, 7.0, 9.0, 11.0, 13.0, 11.0, 0.8, 7.0,
                15.0, 120.0,
            ],
            3: [
                1.0, 2.0, 8.0, 5.0, 11.0, 9.0, 12.0, 15.0, 18.0, 16.0, 0.9,
                10.0, 21.0, 230.0,
            ],
            4: [
                1.0, 2.0, 3.0, 3.0, 4.0, 4.0, 4.0, 5.0, 6.0, 5.0, 0.7, 4.0,
                6.0, 27.0,
            ],
        },
    }
    ...
    try:
        attributes['piE'] = _dic_piE[attributes['category_id']][attributes['subcategory_id']][attributes['environment_active_id'] - 1]
    except TypeError as _error:
        print(_error)
        attributes['piE'] = _dic_piE[attributes['category_id']][attributes['environment_active_id'] - 1]
