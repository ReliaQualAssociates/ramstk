...
def get_part_count_lambda_b(subcategory_id, environment_active_id, specification_id=None):
    r"""
    ...
    """
    if subcategory_id == 1:
        _base_hr = PART_COUNT_LAMBDA_B[subcategory_id][specification_id][environment_active_id - 1]
    else:
        _base_hr = PART_COUNT_LAMBDA_B[subcategory_id][environment_active_id - 1]
