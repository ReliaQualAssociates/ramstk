...
PART_COUNT_LAMBDA_B: Dict[int, List[float]] = {
    ...
    2: [0.15, 0.44, 2.7, 1.2, 4.3, 1.5, 2.7, 1.9, 3.3, 6.8, 0.74, 3.7, 9.9, 180.0],
    3: [0.33, 0.99, 5.9, 2.6, 9.5, 3.3, 5.9, 4.3, 7.2, 15.0, 0.16, 8.2, 22.0, 390.0],
    4: [
        0.56,
        1.7,
        10.0,
...
PART_COUNT_LAMBDA_B_BREAKER: Dict[int, List[float]] = {
    1: [0.11, 0.23, 1.7, 0.91, 3.1, 0.8, 1.0, 1.3, 1.4, 5.2, 0.057, 2.8, 7.5, 0.0],
    2: [
        0.060,
        0.12,
        0.90,
...
PI_C = {1: [1.0, 1.5, 1.7, 2.0, 2.5, 3.0, 4.2, 5.5, 8.0], 5: [1.0, 2.0, 3.0, 4.0]}
PI_E = {
    1: [
        1.0,
        3.0,
    ...
    5: [1.0, 2.0, 15.0, 8.0, 27.0, 7.0, 9.0, 11.0, 12.0, 46.0, 0.5, 25.0, 67.0, 0.0],
}
