...
class AnalysisManager(RAMSTKAnalysisManager):
    ...
    def __init__(
        ...
        pub.subscribe(
            super().on_get_all_attributes, "succeed_get_similar_item_attributes"
        )
        ...
        pub.subscribe(self._do_calculate_similar_item, "request_calculate_similar_item")
        pub.subscribe(
    ...
    def _do_calculate_topic_633(self, node: treelib.Node) -> None:
        ...
        :rtype: None
        """
        _attributes: Dict[str, Any] = node.data["similar_item"].get_attributes()
        ...
        node.data["similar_item"].change_factor_1 = _attributes["change_factor_1"]
        node.data["similar_item"].change_factor_2 = _attributes["change_factor_2"]
        node.data["similar_item"].change_factor_3 = _attributes["change_factor_3"]
    ...
    def _do_roll_up_change_descriptions(self, node: treelib.Node) -> None:
        ...
        node.data["similar_item"].change_description_10 = _change_description_10
    ...
    def _on_get_hardware_attributes(self, tree) -> None:
        ...
        :param tree: the Similar Item datamanager treelib.Tree().
        :return: None
        :rtype: None
        """
