...
class AnalysisManager(RAMSTKAnalysisManager):
    ...
    def __init__(
        ...
        pub.subscribe(super().on_get_all_attributes, "succeed_get_hazard_attributes")
    ...
    def do_calculate_fha(self, node_id: int) -> None:
        ...
        You must ensure the analysis manager has an up to date _attributes dict
        before calling this method.  Send the "request_get_hazard_attributes"
        message with the node ID for the node to calculate.
    ...
    def _do_calculate_hri(self) -> None:
        ...
        self._attributes["system_hri"] = fha.calculate_hri(
            self._attributes["system_probability"], self._attributes["system_severity"]
        )
    ...
    def _do_calculate_user_defined(self) -> None:
        ...
        _fha = fha.set_user_defined_floats(
            _fha,
            [
                self._attributes["user_float_1"],
                self._attributes["user_float_2"],
        ...
        _fha = fha.set_user_defined_ints(
            _fha,
            [
                self._attributes["user_int_1"],
                self._attributes["user_int_2"],
        ...
        _fha = fha.set_user_defined_functions(
            _fha,
            [
                self._attributes["function_1"],
                self._attributes["function_2"],
                self._attributes["function_3"],
                self._attributes["function_4"],
        ...
        _fha = fha.set_user_defined_results(
            _fha,
            [
                self._attributes["result_1"],
                self._attributes["result_2"],
                self._attributes["result_3"],
                self._attributes["result_4"],
